...
import { BrainCircuit, ChevronRight, Github, Mail, Menu, Sparkles, Zap, Shield, Database } from "lucide-react";
    ...
    <div className="min-h-screen bg-background relative overflow-x-hidden transition-colors duration-300">
      ...
      <header className="fixed top-0 w-full z-50 bg-background/80 backdrop-blur-md border-b transition-colors duration-300">
        <div className="container mx-auto px-4 h-16 flex items-center justify-between">
          <div className="flex items-center gap-2 cursor-pointer group" onClick={() => {
            ...
            <span className="font-display font-bold text-xl tracking-tight group-hover:text-primary transition-colors">CHIMERA</span>
          </div>
          ...
          <div className="hidden md:flex items-center gap-6">
            ...
            <div className="flex items-center gap-4 pl-6 border-l">
              ...
              <Button variant="ghost" size="icon" asChild className="hover:bg-secondary/50">
                <a
                  href="https://github.com/yourusername/chimera"
                  target="_blank"
            ...
            >
                ...
                <div className="space-y-8">
                  <div className="space-y-4">
                    ...
                    >
                      ...
                      Powered by DeepSeek R1 (Free & Open Source)
                    </motion.div>
                    <h1 className="text-5xl md:text-6xl lg:text-7xl font-display font-bold tracking-tight text-foreground leading-[1.1]">
                      Transform ideas into <span className="text-transparent bg-clip-text bg-gradient-to-r from-primary to-blue-600">architecture blueprints</span>
                    </h1>
                    <p className="text-xl text-muted-foreground max-w-lg leading-relaxed">
                      Describe your project and let CHIMERA's AI generate comprehensive software architecture plans with best practices, tech stack recommendations, and implementation roadmaps.
                    </p>
                  </div>
                  ...
                  >
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-xs text-muted-foreground">Smart Architecture</p>
                      </div>
                    </div>
                  </motion.div>
                </div>
              ...
              <div id="about" className="py-20 border-t">
                <div className="max-w-3xl mx-auto text-center space-y-12">
                  <div className="space-y-4">
                    <h2 className="text-3xl md:text-4xl font-display font-bold">About CHIMERA</h2>
                    <p className="text-lg text-muted-foreground leading-relaxed">
                      CHIMERA is an AI-powered command center that transforms your project requirements into complete software architecture solutions. Leveraging advanced AI, we analyze your descriptions and generate optimal architecture patterns, best practices, and implementation strategies.
                    </p>
                  </div>
                  ...
                  <div className="grid md:grid-cols-3 gap-8">
                    <motion.div whileHover={{ y: -5 }} className="p-6 bg-card rounded-2xl border shadow-sm hover:shadow-md transition-shadow">
                      ...
                      <p className="text-sm text-muted-foreground">Uses DeepSeek R1 to understand context and generate comprehensive architecture plans.</p>
                    </motion.div>
                    <motion.div whileHover={{ y: -5 }} className="p-6 bg-card rounded-2xl border shadow-sm hover:shadow-md transition-shadow">
                      <div className="w-12 h-12 bg-primary/10 rounded-xl flex items-center justify-center mx-auto mb-4">
                      ...
                      <p className="text-sm text-muted-foreground">Get security, scalability, and deployment recommendations from industry experts.</p>
                    </motion.div>
                    <motion.div whileHover={{ y: -5 }} className="p-6 bg-card rounded-2xl border shadow-sm hover:shadow-md transition-shadow">
                      <div className="w-12 h-12 bg-primary/10 rounded-xl flex items-center justify-center mx-auto mb-4">
                      ...
                      <p className="text-sm text-muted-foreground">7-phase implementation roadmap with tech stack and timeline estimates.</p>
                    </motion.div>
                  </div>
                </div>
              </div>
                ...
                <div className="max-w-xl mx-auto text-center space-y-8">
                  ...
                  <div className="flex flex-col gap-4 items-center">
                    <Button size="lg" className="gap-2 rounded-full px-8 hover:scale-105 transition-transform" asChild>
                      <a href="mailto:hello@chimera.ai">
      ...
      <footer className="border-t py-8 bg-background/50 backdrop-blur-sm">
        <div className="container mx-auto px-4 text-center text-sm text-muted-foreground">
          <p>© {new Date().getFullYear()} CHIMERA. Built with <span className="text-red-500 animate-pulse">♥</span> for developers.</p>
        </div>
      </footer>
    </div>
  );
